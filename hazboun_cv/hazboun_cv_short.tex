...
\cvitemwithcomment{}{\hspace{0.4cm}${\color{color1} \circ}\;$ \textit{\textbf{Co-chair}}, International Pulsar Timing Array Gravitational-wave Analysis Group}{Mar 2018--} \vspace{-0.1cm}
...
{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{31} papers published in major peer-reviewed journals}, {\textbf{1} paper in submission stage,} \\
& &{(out of which \textbf{11} are first-authored papers, and \textbf{3} papers were covered by press releases).}
\end{tabular}
}

$\bullet$ \textbf{Total number of citations:} 1033 (using Google Scholar), \textbf{h-index:} 17, \textbf{i10-index:} 23
...
\item \cvitem{}{``\textit{Cosmology using advanced gravitational-wave detectors alone}''. \textit{\textbf{S.~R.~Taylor}}, J.~R.~Gair, and I.~Mandel. \href{http://journals.aps.org/prd/abstract/10.1103/PhysRevD.85.023535}{{\color{color1} Phys. Rev. D, 85(2):023535 (2012)}}. \textcolor{red}{$\bullet$} $53$ peer-reviewed citations.}
