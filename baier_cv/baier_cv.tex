...
\hspace{0.71cm} Bombs Away Cafe, 3rd Tuesday of the Month  \\
\hbox{\hspace{0.71cm} 900+ Attendees and counting}
...
\software{enterprise\_extensions}{A set of extensions, utilities, and scripts for the enterprise PTA analysis code.}{https://github.com/nanograv/enterprise_extensions}
\software{la\_forge}{PTA data visualization and post processing}{https://github.com/nanograv/la_forge}
...
\talkitem{Noise characterization and mitigation in the NANOGrav detector}{Master's Defense}{Corvallis, Oregon, March 2025}
...
\section{Conferences}
\begin{etaremune}[leftmargin=8mm]
	\confitem{Gravitational Wave Astronomy Northwest}{Hanford, WA}{August 2026}
